...
echo "============================="
echo "cloning some REPOSITORIES"
echo "============================="
git clone https://github.com/JulienPascal/Palvit.git
git clone https://github.com/JulienPascal/Minimum-Wage-in-a-Dynamic-Search-Matching-Model.git
git clone https://github.com/JulienPascal/The-Macro-dynamics-of-Sorting-.git
